...
# training
chemprop_train --data_path chemprop.csv --dataset_type regression --save_dir biolog_model_test --num_folds 10 --split_type cv --ensemble_size 20 --features_generator rdkit_2d_normalized --no_features_scaling --gpu 0 --config_path hyperopt.json
# prediction
